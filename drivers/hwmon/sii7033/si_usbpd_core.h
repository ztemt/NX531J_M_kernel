...
bool usbpd_process_msg(struct sii_usbpd_protocol *pd,
...
bool usbpd_xmit_ctrl_msg(struct sii_usbpd_protocol *pd,
	enum ctrl_msg type);

bool usbpd_svdm_init_resp(struct sii_usbpd_protocol *pd, uint8_t cmd,
		bool is_rcvd,
		uint32_t *vdo);
